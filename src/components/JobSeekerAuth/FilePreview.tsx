...
const FilePreview: React.FC<FilePreviewProps> = ({ file, onRemove, onChange }) => {
        ...
        <div className="flex items-center space-x-4 mt-2">
          {previewUrl ? (
            <motion.img
              src={previewUrl}
              alt="File preview"
              className="w-40 h-40 object-cover rounded-lg border border-purple-600 shadow-[0_0_8px_#7c3aed] hover:scale-105 transition-transform duration-500"
